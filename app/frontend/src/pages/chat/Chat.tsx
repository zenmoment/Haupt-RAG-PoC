                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            <SparkleFilled fontSize={"120px"} primaryFill={"rgba(91, 188, 35, 1)"} aria-hidden="true" aria-label="Chat logo" />
                            <h1 className={styles.chatEmptyStateTitle}>Chatte mit deinen Büchern</h1>
                            <h2 className={styles.chatEmptyStateSubtitle}>Frage irgendetwas oder versuche es mit einem der Beispiele</h2>
                    ...
                    <div className={styles.chatInput}>
                        <QuestionInput
                            clearOnSend
                            placeholder="Stell eine neue Frage"
                            disabled={isLoading}
